...
The source POM pins an exact Bridge baseline. Canonical Bridge artifacts come from `io.github.supracraft` in the `SupraCraft/Bridge` GitHub Packages repository.
...
- source line: `X.Y.Z-dev` (currently `2.9.1-dev`)
...
- normalized SupraCraft development line is `2.9.1-dev`
