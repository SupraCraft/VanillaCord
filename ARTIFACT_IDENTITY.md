...
Bridge dependencies consume SupraCraft-owned `io.github.supracraft` coordinates.
...
- source/development line: `2.9.1-dev`
- immutable main-branch CI build: `2.9.1-dev.<github-run-number>`
