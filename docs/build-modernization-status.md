...
Bridge PR #3 merged as `3accd1ad5548e0b16a58e0665b9c40953c6124ef` with canonical `io.github.supracraft` coordinates and immutable `0.1.0-dev.<run>` CI versions.

VanillaCord PR #20 merged as `303d2af90a3c7b6afbebe334ce62ddc1cf626d76` with:

- canonical `io.github.supracraft:vanillacord`
- source line `2.9.1-dev`
- CI `2.9.1-dev.<run>`, RC `2.9.0-rc.N`, stable `2.9.0`
